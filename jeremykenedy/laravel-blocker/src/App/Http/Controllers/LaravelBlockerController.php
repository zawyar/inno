...
class LaravelBlockerController extends Controller
{
    ...
    {
        $password_generator_length = WebsiteSettings::where('key', '=', 'password_generator_length')->pluck('value');
        $password_generator_characters = WebsiteSettings::where('key', '=', 'password_generator_characters')->pluck('value');

        View::share('password_generator_length', $password_generator_length);
        View::share('password_generator_characters', $password_generator_characters);
